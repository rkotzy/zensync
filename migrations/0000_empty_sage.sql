...
CREATE INDEX `idx_channels_slack_connection_id` ON `channels` (`slack_connection_id`);--> statement-breakpoint
...
CREATE INDEX `idx_conversations_external_id` ON `conversations` (`external_id`);--> statement-breakpoint
...
CREATE INDEX `idx_slack_connection_team_id` ON `slack_connections` (`slack_team_id`);--> statement-breakpoint
CREATE INDEX `idx_slack_connection_subscription_id` ON `slack_connections` (`subscription_id`);--> statement-breakpoint
...
CREATE UNIQUE INDEX `zendesk_connections_slack_connection_id_unique` ON `zendesk_connections` (`slack_connection_id`);--> statement-breakpoint
CREATE INDEX `idx_zendesk_connection_webhook_id` ON `zendesk_connections` (`zendesk_webhook_id`);--> statement-breakpoint
CREATE INDEX `idx_zendesk_connection_slack_connection_id` ON `zendesk_connections` (`slack_connection_id`);