...
export const slackConnection = sqliteTable(
  'slack_connections',
  {
  ...
  table => ({
    idx_slack_connection_team_id: index('idx_slack_connection_team_id').on(
      table.slackTeamId
    ),
    idx_slack_connection_subscription_id: index(
...
export const zendeskConnection = sqliteTable(
  ...
  table => ({
    ...
    idx_zendesk_connection_slack_connection_id: index(
...
export const conversation = sqliteTable(
  ...
  table => ({
    ...
    idx_conversations_external_id: index('idx_conversations_external_id').on(
      table.externalId
    )
  })
);
...
export const subscription = sqliteTable(
  ...
  table => ({
    idx_subscriptions_stripe_subscription_id: index(
