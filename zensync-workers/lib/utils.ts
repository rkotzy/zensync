...
export enum InteractivityActionId {
  ...
  ZENDESK_SETUP_MODAL_ID = 'zendesk-setup-modal',
  ZENDESK_UPDATE_MODAL_ID = 'zendesk-update-modal',
...
export function sanitizeZendeskConnectionInputs(values: any): {
  ...
  return { zendeskDomain, zendeskEmail, zendeskKey };
}
